...
class ImageTransformerDenoiserModel(nn.Module):
    ...
    def forward(self, x, timesteps, control = None):
        ...
        x, control = self.process_input(x, control) # x: (1, 3, 256, 256) -> (1, 6, 256, 256)

        x = x.movedim(-3, -1)   # x: (1, 6, 256, 256) -> (1, 256, 256, 6)
        x = self.patch_in(x)    # x: (1, 256, 256, 6) -> (1, 256/p, 256/p, 128)
